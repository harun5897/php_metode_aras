...
if(isset($_POST['b_simpan'])) {
    simpan_kriteria($koneksi, $_POST['nama_kriteria'], $_POST['bobot'], $_POST['jenis']);
}
if(isset($_POST['b_edit'])) {
    edit_kriteria($koneksi, $_POST['nama_kriteria'], $_POST['bobot'], $_POST['jenis'], $_GET['id']);
}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-warning text-white">
                    <h5 class="modal-title" id="exampleModalLabel"> <i class="fas fa-user-plus"></i> Edit Kriteria</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" action="">
                        <div class="form-group row">
                            <label for="" class="col-sm-4 col-form-label">Nama Kriteria</label>
                            <div class="col-sm-8">
                            <input type="text" class="form-control" name="nama_kriteria" value='<?=@$arr_edit['nama_kriteria']?>'>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="col-sm-4 col-form-label">Bobot</label>
                            <div class="col-sm-8">
                            <input type="text" class="form-control" name="bobot"  value='<?=@$arr_edit['bobot']?>'>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="col-sm-4 col-form-label">Jenis</label>
