                ...
                <div class="modal-body">
                    <form method="post" action="">
                        <div class="form-group row">
                            <label for="" class="col-sm-4 col-form-label">Nama Guru</label>
                            <div class="col-sm-8">
                                <select class="custom-select" name="nama_guru">
                                    <?php
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select class="custom-select" name="nama_kriteria">
                                    <?php
                                    $obj_kriteria = mysqli_query($koneksi, "SELECT * FROM tb_kriteria");
                                    while($arr_kriteria = mysqli_fetch_array($obj_kriteria)) :
                                    ?>
                                    <option value="<?=$arr_kriteria['id']?>"><?=$arr_kriteria['nama_kriteria']?></option>
                                    <?php
                                        endwhile;
                                    ?>
