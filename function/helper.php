<?php
    ...
    function simpan_kriteria ($koneksi, $nama_kriteria, $bobot, $jenis) {

        mysqli_query($koneksi, "INSERT INTO tb_kriteria (nama_kriteria, bobot, jenis) 
        VALUES ('$nama_kriteria', '$bobot', '$jenis') ");
    ...
    function edit_kriteria ($koneksi, $nama_kriteria, $bobot, $jenis, $id) {
